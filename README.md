# snowping:json-routes

<https://atmospherejs.com/snowping/json-routes>

FORK WITH QUICK AND DIRTY FIX TO INCREASE REQUEST ENTITY SIZE LIMIT (FROM 1MB to 50MB)
https://github.com/stubailo/meteor-rest/issues/75
